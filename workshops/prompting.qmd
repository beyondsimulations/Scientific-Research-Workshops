...
**Prompt 1** would get a generic overview of statistical tests. **Prompt 2** gives enough context for a [specific recommendation]{.highlight}. **Prompt 3** addresses a real complication and asks for [usable output]{.highlight}. Each prompt gives the model more to work with — a clearer task and more context — which is what [turns a vague question into a concrete answer]{.highlight}.
