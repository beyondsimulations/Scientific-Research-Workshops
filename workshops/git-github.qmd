...
Zed has [built-in Git support]{.highlight}: the **Git panel** shows all changed files at a glance, you can **check the box** next to a file to stage it, **type a commit message** and commit without leaving the editor, and the **diff view** shows exactly which lines changed inline. Colored **gutter markers** in the margin indicate added, modified, and deleted lines.
