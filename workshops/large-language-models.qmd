...
All four offer free access to capable models, while paid tiers unlock stronger models and higher usage limits. Mistral also offers an [affordable student tier]{.highlight} that includes Mistral Vibe, its terminal-based coding agent (covered below).
...
Terminal-based coding assistants let you work with AI [directly from the command line]{.highlight}, without leaving your editor or browser. Several options stand out:
