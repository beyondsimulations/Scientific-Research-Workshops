...
Several tools now use AI to [help you find papers faster]{.highlight}. They complement traditional database searches: they surface papers that keyword search misses, show how papers relate to each other, and give you a quick overview of a research field.
...
Do not accept results at face value. Is the [sample size]{.highlight} sufficient? Are the assumptions reasonable? Do the conclusions actually follow from the results? Would the findings hold in other contexts? And what limitations do the authors leave undiscussed?
